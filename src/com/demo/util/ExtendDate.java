 ...
 public class ExtendDate
{
    ...
    */
    ...
    public static Date getEffectiveDate(Date nxtAdjuDate, int frequency){
       if(frequency==0){
    	   return nxtAdjuDate;
       }
       else if(frequency==1){
    	   return ExtendDate.rollMonths(nxtAdjuDate, 1);
       }
       else if(frequency==3){
    	   	return ExtendDate.rollMonths(nxtAdjuDate, 3);
       }
       else if(frequency==6){
    	   return ExtendDate.rollMonths(nxtAdjuDate, 6);
       }
       else if(frequency==12){
    	   return ExtendDate.rollYears(nxtAdjuDate, 1);
       }
       else if(frequency==14){
    	   return ExtendDate.rollDays(nxtAdjuDate, 14);
       }
    ...
    public static void main(String args[]){
         ...
         //System.out.println(ExtendDate.rollDate(date1, 2, 0));
         /*System.out.println(ExtendDate.rollDays(date1, 2));
         System.out.println(ExtendDate.rollMonths(date1, 3));
         System.out.println(ExtendDate.rollDate(date1, 1, 0));*/
         System.out.println(ExtendDate.getEffectiveDate(date1, 1));
    }
}